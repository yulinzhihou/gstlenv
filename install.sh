...
EOF
    ...
    if [ ! -f /usr/local/bin/docker-compose ]; then
        curl -L https://get.daocloud.io/docker/compose/releases/download/${DOCKER_COMPOSER_VERSION:-2.12.2}/docker-compose-$(uname -s)-$(uname -m) -o /usr/local/bin/docker-compose
